...
describe('Category unit tests', () => {
  ...
  test('should test required props of Category', () => {
    ...
    expect(() => { new Category({ name: undefined }) }).toThrow(error);
    expect(() => { new Category({ name: null }) }).toThrow(error);
    expect(() => { new Category({ name: '' }) }).toThrow(error);
    expect(() => { new Category({ name: '    '}) }).toThrow(error);
  });

  test('should test Category is null or undefined', () => {
    expect(() => { new Category(null) }).toThrow(new Error('Category is null or undefined!'));
    expect(() => { new Category(undefined) }).toThrow(new Error('Category is null or undefined!'));
  });
